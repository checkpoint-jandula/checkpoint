...
**Polygon** ([https://www.polygon.com/](https://www.polygon.com/)) es un sitio web de noticias, reseñas y contenido de vídeo sobre videojuegos, perteneciente a Vox Media. Se caracteriza por un estilo editorial distintivo y la publicación de artículos de fondo. Al igual que IGN, su rol es el de un medio de comunicación, y no ofrece herramientas para la organización de ludotecas personales ni una plataforma social dedicada a la gestión y compartición de experiencias de juego detalladas por parte de sus usuarios. Su contenido está influenciado por su línea editorial y se financia mediante publicidad.
...
-   **PostgreSQL:** ([https://www.postgresql.org/](https://www.postgresql.org/ "null")) Sistema de gestión de bases de datos relacional objeto-relacional, elegido por su fiabilidad, características avanzadas y licencia de código abierto.
...
-   **Problema:** Se experimentaron demoras en las fases iniciales concernientes a la aprobación formal del anteproyecto y la asignación de un tutor responsable. Esta circunstancia, sumada a una falta de pautas detalladas o un guion orientativo inicial sobre las expectativas específicas para el Trabajo de Fin de Grado (TFG), generó una incertidumbre inicial que afectó la planificación temprana.
    ...
    -   **Contexto Adicional:**  _(Opcional, si quieres incluirlo con cuidado)_ Se percibió una diferencia en los tiempos de preparación y definición de proyecto en comparación con alumnos de otros itinerarios formativos (DAM), quienes pudieron contar con un periodo más extenso para perfilar sus propuestas mientras aún cursaban asignaturas, una oportunidad no disponible en la misma medida para el equipo (DAW) debido a factores externos como la baja por paternidad del tutor inicialmente previsto. _(Este punto es delicado, asegúrate de que el tono sea puramente descriptivo del contexto y no una queja)._
        
-   **Solución/Abordaje:** Ante la falta de feedback temprano sobre la viabilidad o el dimensionamiento del anteproyecto, el equipo procedió con la visión inicial, lo que derivó en una rápida escalada del alcance. Una vez asignado un responsable y obtenida una mayor claridad, se realizaron esfuerzos para redefinir prioridades y ajustar el alcance funcional en la medida de lo posible, aunque el cronograma ya se había visto afectado. Se intensificó la comunicación con el tutor asignado para validar las decisiones de diseño y desarrollo subsiguientes.
    
-   **Aprendizaje:** La importancia de una definición temprana y realista del alcance, así como la necesidad de contar con un feedback ágil en las fases iniciales de un proyecto, se revelaron como cruciales. Se comprendió la necesidad de ser proactivos en la búsqueda de guía y en la autogestión del proyecto ante imprevistos.
...
-   **Solución/Abordaje:** Se adoptaron principios de la metodología ágil, como la división del trabajo en módulos e iteraciones más pequeñas, para mejorar la gestión y la visibilidad del progreso. Se fomentó la comunicación constante dentro del equipo para identificar cuellos de botella y reasignar esfuerzos. Las reestructuraciones de diseño, aunque consumieron tiempo, se consideraron necesarias para asegurar la viabilidad y calidad a largo plazo de la arquitectura.
    
-   **Aprendizaje:** Este desafío subrayó la importancia crítica de la planificación detallada, la estimación realista de tareas y la flexibilidad para adaptar los planes. Se adquirió una valiosa experiencia en la gestión de la complejidad y en la toma de decisiones técnicas bajo presión temporal.
    
-   **Problema:** Los conocimientos de base en tecnologías backend, específicamente Spring Boot, adquiridos durante la formación académica, resultaron ser un punto de partida que necesitó una expansión considerable para afrontar la complejidad de MyCheckPoint. La necesidad de implementar funcionalidades como la comunicación asíncrona con APIs externas o la gestión avanzada de relaciones en la base de datos requirió un aprendizaje autodidacta intensivo durante el desarrollo.
    
-   **Solución/Abordaje:** Se dedicó tiempo específico a la investigación y aprendizaje de nuevas características y librerías del ecosistema Spring, como Spring WebFlux (para el `WebClient` reactivo utilizado en la integración con IGDB). Se consultó documentación oficial, tutoriales y foros de la comunidad para resolver dudas técnicas y aplicar las mejores prácticas. Este proceso de autoaprendizaje fue fundamental para superar las limitaciones iniciales.
    
-   **Aprendizaje:** El TFG se convirtió en una oportunidad significativa para profundizar y expandir los conocimientos en desarrollo backend, especialmente en áreas como la programación reactiva, la optimización de consultas JPA/Hibernate y el diseño de APIs RESTful complejas. Se valoró la capacidad de aprender y aplicar nuevas tecnologías de forma autónoma.
    
-   **Problema:** La elección inicial de la tecnología frontend contempló el uso de React, un framework que suscitaba interés en el equipo por sus características y la oportunidad de aprendizaje. Sin embargo, tras una evaluación inicial y considerando el cronograma ajustado del proyecto, se constató que la curva de aprendizaje para alcanzar la productividad deseada en React sería considerable.
    
-   **Solución/Abordaje:** Tras un breve periodo de exploración con React (aproximadamente un día de desarrollo), se tomó la decisión pragmática de pivotar hacia Vue.js. Esta elección se basó en la familiaridad preexistente y las bases más sólidas que el equipo poseía en Vue, lo que permitiría un desarrollo más ágil y eficiente del frontend, minimizando riesgos asociados al cumplimiento de los plazos.
    
-   **Aprendizaje:** Esta experiencia resaltó la importancia de equilibrar los objetivos de aprendizaje con las restricciones prácticas de un proyecto con plazos definidos. Se comprendió que, en ocasiones, optar por tecnologías con las que ya se cuenta con una mayor competencia puede ser crucial para garantizar la viabilidad y entrega del proyecto, aunque esto implique posponer la exploración de otras herramientas de interés. El desarrollo frontend en Vue.js, por tanto, sirvió para reforzar y afianzar los conocimientos existentes.
    
-   **Problema:** La dinámica de trabajo en equipo, especialmente en un proyecto de fin de grado con plazos ajustados y la presión inherente, presentó desafíos comunicacionales en ciertas etapas del desarrollo. Discrepancias en enfoques técnicos o prioridades llevaron a discusiones que, en ocasiones, ralentizaron el ritmo de trabajo.
    
-   **Solución/Abordaje:** Se reconoció la importancia de mejorar la comunicación interna. Se establecieron mecanismos para asegurar que todas las opiniones fueran escuchadas y consideradas de forma constructiva. Se fomentó el diálogo abierto y la búsqueda de consensos, priorizando el avance del proyecto y el aprendizaje mutuo sobre la imposición de visiones individuales. Este proceso implicó un esfuerzo consciente por parte de ambos miembros del equipo para mejorar las habilidades de escucha activa y negociación.
...
-   **Problema:** La integración con la API de IGDB presentó varios desafíos:
    ...
    -   **Documentación de la API:** Inicialmente, se encontraron dificultades debido a que la documentación oficial de la API de IGDB no siempre se percibió como completamente actualizada o exhaustiva. En ciertos apartados, la estructura de los datos devueltos por las llamadas reales a la API difería de lo especificado en la documentación, lo que requirió un proceso de prueba y error para comprender la estructura real de las respuestas y ajustar el mapeo de datos.
        
    -   **Complejidad y Consistencia de Datos:** La estructura de datos de IGDB es extensa y, en ocasiones, la información para ciertos juegos puede ser inconsistente, incompleta o presentar formatos variables. La normalización de estos datos para su persistencia en el modelo relacional de MyCheckPoint y la gestión de las múltiples relaciones entre entidades de juego (DLCs, expansiones, géneros, plataformas, etc.) requirió un diseño cuidadoso y estrategias de mapeo complejas.
        
    -   **Definición del Alcance de Datos a Integrar:** En las fases iniciales, se contempló la integración de un volumen mayor de campos específicos de IGDB, como información detallada sobre idiomas soportados o perspectivas del jugador. Sin embargo, la creciente complejidad del backend y las limitaciones de tiempo obligaron a realizar una selección crítica de los datos más relevantes para las funcionalidades centrales de MyCheckPoint, posponiendo la integración de campos más granulares.
        
-   **Solución/Abordaje:**
    
    -   Para superar las limitaciones de la documentación, se realizaron numerosas pruebas directas contra la API de IGDB utilizando herramientas como Postman. Se analizaron las respuestas JSON crudas para identificar los campos correctos y sus tipos de datos, adaptando los DTOs y la lógica de mapeo en consecuencia. Se priorizó la información obtenida de las respuestas reales sobre la documentación cuando existían discrepancias.
        
    -   Se diseñó un `GameService` robusto encargado de orquestar la obtención de datos de IGDB y su transformación a las entidades locales. Se implementó una lógica para diferenciar entre datos "parciales" (obtenidos de búsquedas) y "completos" (obtenidos de una petición detallada), marcando las entidades locales consecuentemente (`isFullDetails`).
        
    -   Se utilizaron mapeadores MapStruct con lógica personalizada (`@AfterMapping`, métodos `default`) para manejar las transformaciones complejas y la correcta asignación de relaciones, especialmente para las jerarquías de juegos (padre/hijo) y las colecciones de entidades asociadas (géneros, plataformas, etc.).
        
    -   Se implementaron estrategias de "obtener o crear" (`getOrCreate...`) para las entidades maestras (Genre, Platform, Company, etc.) para evitar duplicados y asegurar la consistencia, actualizando sus datos si se encontraban versiones más recientes en IGDB.
        
    -   La gestión de las relaciones ManyToMany y OneToMany se abordó cuidadosamente con las anotaciones JPA y la configuración de cascadas, prestando especial atención al ciclo de vida de las entidades y al orden de persistencia para evitar errores de integridad referencial o de objetos detached.
        
    -   Respecto al alcance de los datos, se realizó una priorización de los campos de IGDB a integrar, centrándose en aquellos esenciales para la experiencia del usuario y las funcionalidades clave del MVP (Producto Mínimo Viable), dejando la puerta abierta a futuras ampliaciones.
...
-   **Solución/Abordaje:**
    ...
    -   Se utilizó la anotación `@Transactional` de Spring para asegurar la atomicidad de las operaciones complejas en la capa de servicio.
        
    -   Se prestó especial atención al orden de las operaciones de persistencia y al uso de `entityManager.flush()` y `entityManager.refresh()` en momentos críticos para sincronizar el contexto de persistencia de Hibernate con el estado real de la base de datos antes de realizar manipulaciones de colecciones que pudieran depender de cambios de FK ya persistidos.
        
    -   Se implementaron lógicas cuidadosas para la reordenación de ítems y secciones, asegurando que los índices de orden se mantuvieran consistentes.
...
El proyecto MyCheckPoint surge de una necesidad personal y compartida por muchos aficionados a los videojuegos: la de contar con un espacio digital unificado para catalogar sus experiencias lúdicas, organizar sus colecciones de forma detallada y compartir su pasión con otros jugadores. Inspirado en la práctica de registrar manualmente los juegos completados y crear clasificaciones personales, este Trabajo de Fin de Grado se propuso desarrollar una plataforma web que ofreciera estas funcionalidades de manera integrada y enriquecida, superando las limitaciones observadas en las herramientas existentes y sirviendo como una "cápsula del tiempo" digital para la trayectoria lúdica de cada usuario.

A lo largo de este documento, se ha detallado el proceso integral de concepción, análisis, diseño, desarrollo y validación de la plataforma MyCheckPoint. Se ha comenzado estableciendo el contexto y la justificación del proyecto, seguido de una revisión exhaustiva de las alternativas existentes en el sector de los videojuegos y otros ámbitos del entretenimiento. Posteriormente, se han definido con precisión los objetivos generales y específicos que han guiado la implementación. La sección de desarrollo ha expuesto la planificación temporal, la metodología ágil adaptada, las tecnologías seleccionadas para el backend (Java Spring Boot) y el frontend (Vue.js), la arquitectura del sistema, los requisitos funcionales implementados y los principales desafíos técnicos y de gestión afrontados, junto con las soluciones aplicadas.
...
-   **Integración con Lanzadores Externos:**
    ...
    -   **Importación de Bibliotecas:** Desarrollar la capacidad de importar automáticamente las bibliotecas de juegos de los usuarios desde plataformas populares como Steam, Epic Games Store, GOG, etc. Esto facilitaría enormemente la carga inicial de datos para nuevos usuarios y mantendría sus colecciones sincronizadas con menor esfuerzo manual.
        
-   **Mejoras en la Página de Inicio y Descubrimiento:**
    
    -   **Contenido Dinámico en la Home:** Poblar la página de inicio con secciones dinámicas que muestren juegos populares en la plataforma, nuevos lanzamientos destacados, los títulos mejor valorados por la comunidad de MyCheckPoint, o actividad relevante de amigos.
        
    -   **Sistema de Recomendaciones Personalizadas:** Implementar un motor de recomendaciones que sugiera juegos a los usuarios basándose en sus gustos, los juegos en su biblioteca, sus puntuaciones, y la actividad de usuarios con perfiles similares.
        
-   **Nuevas Funcionalidades Interactivas:**
    
    -   **Ruleta Aleatoria de Juegos:** Añadir una herramienta lúdica, similar al sistema de "jugar algo aleatorio" de servicios como Game Pass, que permita a los usuarios obtener una sugerencia aleatoria de su propia biblioteca (filtrable por estado, plataforma, etc.) para ayudarles a decidir a qué jugar.
        
    -   **Sistema de Valoración para Listas y Tier Lists:** Implementar un sistema de "likes" y "dislikes" (o un sistema de valoración más granular) para las GameLists y TierLists públicas creadas por los usuarios, permitiendo a la comunidad destacar el contenido más útil o interesante.
        
    -   **Rankings Globales de Videojuegos:** Desarrollar un sistema que genere rankings de videojuegos basados en las 'tier lists' agregadas de los usuarios, ofreciendo una perspectiva comunitaria sobre la popularidad o valoración de los títulos.
        
    -   **Gestión y Visualización de Logros:** Integrar la visualización de logros de los juegos (obteniendo esta información de IGDB o directamente de las plataformas de los usuarios si la importación de bibliotecas lo permite) y permitir a los usuarios marcar los logros conseguidos.
        
-   **Mejoras en la Experiencia de Usuario y Diseño:**
    
    -   **Refinamiento del Estilo Visual:** Continuar iterando sobre el diseño de la interfaz de usuario (UI) y la experiencia de usuario (UX) para mejorar la estética general, la usabilidad en diferentes dispositivos (responsive design) y la accesibilidad.
        
    -   **Opciones de Personalización Avanzadas:** Explorar la posibilidad de ofrecer más temas de interfaz, opciones de personalización para el perfil de usuario, o la capacidad de configurar la disposición de ciertos módulos.
        
-   **Ampliación de Funcionalidades Sociales:**
    
    -   **Notificaciones Avanzadas:** Mejorar el sistema de notificaciones para incluir más tipos de eventos (ej. cuando un amigo añade un juego a su lista de deseos, cuando se comenta una lista que sigues, etc.) y ofrecer mayor control al usuario sobre qué notificaciones desea recibir.
        
    -   **Grupos o Comunidades Temáticas:** Considerar la implementación de grupos de usuarios basados en intereses comunes (géneros de juegos, plataformas, etc.) o foros de discusión para fomentar una interacción más profunda.
        
    -   **Eventos y Retos Comunitarios:** Introducir la posibilidad de crear o participar en eventos o retos de juego dentro de la plataforma (ej. "completar X juegos de un género específico este mes").
        
-   **Aspectos Técnicos y de Mantenimiento:**
    
    -   **Optimización Continua del Rendimiento:** Seguir monitorizando y optimizando el rendimiento del backend y del frontend, especialmente en consultas a la base de datos y en la carga de datos de IGDB.
        
    -   **Pruebas Automatizadas Extensivas:** Ampliar la cobertura de pruebas automatizadas (unitarias, de integración, E2E) para asegurar la estabilidad y fiabilidad de la plataforma a medida que evoluciona.
        
    -   **Internacionalización (i18n) y Localización (l10n):** Preparar la plataforma para su posible traducción a otros idiomas, permitiendo alcanzar una audiencia global.
