  ...
  <header class="main-header">
    <div class="header-content">
      <RouterLink :to="{ name: 'home' }" class="logo-container">
        <img alt="MyCheckPoint Logo" class="logo" src="@/assets/img/CP-LOGOF.png" />
      ...
      <div class="actions-container">
        ...
        <div class="user-auth-group">
          <template v-if="authStore.isAuthenticated && authStore.currentUser">
            <RouterLink :to="{ name: 'profile', params: { publicId: authStore.currentUser.public_id } }" class="user-profile-link" title="Mi Perfil">
