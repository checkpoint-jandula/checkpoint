...
@Component // Anotamos como Component para que Spring lo gestione y podamos inyectarlo
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            if (StringUtils.hasText(jwt) && tokenProvider.validateToken(jwt)) {
                String username = tokenProvider.getUsernameFromToken(jwt); // En nuestro caso, el email
            ...
            // No relanzamos la excepción aquí para permitir que otros filtros actúen
